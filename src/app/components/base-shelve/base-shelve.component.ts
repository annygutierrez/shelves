  ...
  export class BaseShelveComponent {
    ...
    shelvesLevels: ShelfItem[]= [
      ...
      },
      {
        ...
        description: "This is the freak of the group. Dind't like the overly enthusiastic and playful sound of this album, but I was studying Russian, and this album was constantly played on Alina Olesheva's videos, so I ended up liking the entire thing. There are three songs from this album that I loved from the beginnig though.",
      ...
      },
      {
        ...
        description: "Not my genre, but I loved it and didn't know why, then I heared the sound was kind of similar to music I used to hear in teen series and movies in the early 10's. Now I love synth-russian-ukranian-punk",
